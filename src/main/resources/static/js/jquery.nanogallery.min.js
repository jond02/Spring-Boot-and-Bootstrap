...
!1,-1,b);return!0}}function P(){p=[];var b="";f.thumbnailLabel.displayDescription&&(b="d");b=W("dummydummydummy","model:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==","model:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==",b,"","image","","1","0");b=xb(b,0,!1).e$;h.borderWidth=b.outerWidth(!0)-b.width();h.borderHeight=b.outerHeight(!0)-b.height();h.imgcBorderWidth=b.find(".imgContainer").outerWidth(!0)-b.find(".imgContainer").width();
...
b=b.reverse()));jQuery.each(b,function(a,b){var d="";void 0!==jQuery(b).attr("model-ngthumb")&&0<jQuery(b).attr("model-ngthumb").length&&(d=f.itemsBaseURL+jQuery(b).attr("model-ngthumb"));void 0!==jQuery(b).attr("model-ngThumb")&&0<jQuery(b).attr("model-ngThumb").length&&(d=f.itemsBaseURL+jQuery(b).attr("model-ngThumb"));var m="";void 0!==jQuery(b).attr("model-ngthumb2x")&&0<jQuery(b).attr("model-ngthumb2x").length&&(m=f.itemsBaseURL+jQuery(b).attr("model-ngthumb2x"));void 0!==jQuery(b).attr("model-ngThumb2x")&&
0<jQuery(b).attr("model-ngThumb2x").length&&(m=f.itemsBaseURL+jQuery(b).attr("model-ngThumb2x"));src=f.itemsBaseURL+jQuery(b).attr("href");var u="";void 0!==jQuery(b).attr("model-ngdesc")&&0<jQuery(b).attr("model-ngdesc").length&&(u=jQuery(b).attr("model-ngdesc"));void 0!==jQuery(b).attr("model-ngDesc")&&0<jQuery(b).attr("model-ngDesc").length&&(u=jQuery(b).attr("model-ngDesc"));var e="";void 0!==jQuery(b).attr("model-ngdest")&&0<jQuery(b).attr("model-ngdest").length&&(e=jQuery(b).attr("model-ngdest"));void 0!==
jQuery(b).attr("model-ngDest")&&0<jQuery(b).attr("model-ngDest").length&&(e=jQuery(b).attr("model-ngDest"));var h=0;void 0!==jQuery(b).attr("model-ngalbumid")&&(h=jQuery(b).attr("model-ngalbumid"),c=!0);void 0!==jQuery(b).attr("model-ngAlbumID")&&(h=jQuery(b).attr("model-ngAlbumID"),c=!0);var g=null;void 0!==jQuery(b).attr("model-ngid")&&(g=jQuery(b).attr("model-ngid"));void 0!==jQuery(b).attr("model-ngID")&&(g=jQuery(b).attr("model-ngID"));var p="image";void 0!==jQuery(b).attr("model-ngkind")&&0<jQuery(b).attr("model-ngkind").length&&
(p=jQuery(b).attr("model-ngkind"));void 0!==jQuery(b).attr("model-ngKind")&&0<jQuery(b).attr("model-ngKind").length&&(p=jQuery(b).attr("model-ngKind"));var k=jQuery(b).text();""!=f.thumbnailLabel.title&&void 0!=f.thumbnailLabel.title&&(k=N(src));u=W(k,d,src,u,e,p,"",g,h);u.thumbX2src=m;m=0;void 0!==jQuery(b).attr("model-ngthumbImgWidth")&&0<jQuery(b).attr("model-ngthumbImgWidth").length&&(m=jQuery(b).attr("model-ngthumbImgWidth"),u.thumbImgWidth=m);e=0;void 0!==jQuery(b).attr("model-ngthumbImgHeight")&&0<
jQuery(b).attr("model-ngthumbImgHeight").length&&(e=jQuery(b).attr("model-ngthumbImgHeight"),u.thumbImgHeight=e);u.thumbs={url:{l1:{xs:d,sm:d,me:d,la:d,xl:d},lN:{xs:d,sm:d,me:d,la:d,xl:d}},width:{l1:{xs:m,sm:m,me:m,la:m,xl:m},lN:{xs:m,sm:m,me:m,la:m,xl:m}},height:{l1:{xs:e,sm:e,me:e,la:e,xl:e},lN:{xs:e,sm:e,me:e,la:e,xl:e}}};"function"==typeof f.fnProcessData&&f.fnProcessData(u,"markup",null)});jQuery.each(b,function(a,b){jQuery(b).remove()});c&&(f.displayBreadcrumb=!0);b=p.length;for(var a=0,d=0,m=
0;m<b;m++){for(var u=d=a=0;u<b;u++)m!=u&&p[m].GetID()==p[u].albumID&&(a++,"image"==p[u].kind&&(p[u].imageNumber=d++));p[m].contentLength=a}}function tb(b,c,a,d){Ra(b);if(p[b].contentIsLoaded)X(b,d);else{var m=f.customSourceProvider+"?albumID="+encodeURIComponent(p[b].GetID());hb();jQuery.ajaxSetup({cache:!1});jQuery.support.cors=!0;var u=setTimeout(function(){ea();R("Could not retrieve Custom model...")},6E4);jQuery.getJSON(m,function(m,f,e){clearTimeout(u);ea();Xb(b,m);if(c)r(!1)||X(b,d);else if(-1!=
...
var k=setTimeout(function(){ea();R("Could not retrieve Picasa/Google+ model...")},6E4);jQuery.getJSON(m,"callback=?",function(m){clearTimeout(k);ea();ac(b,m,e);if(c)r(!1)||X(b,d);else if(-1!=a){m=-1;for(var f=p.length,h=0;h<f;h++)if("image"==p[h].kind&&p[h].GetID()==a){m=h;break}ta(m,!0)}else X(b,d)}).fail(function(a,b,c){clearTimeout(k);ea();var d="",f;for(f in a)d+=f+"="+a[f]+"<br>";R("Could not retrieve Picasa/Google+ model. Error: "+(b+", "+c+" "+d+"<br><br>URL:"+m))})}}function ac(b,c,a){var d=
...
h=!1;g="model:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==";if("auto"==w()&&0==p[c].thumbImg().height||"auto"==l()&&0==p[c].thumbImg().width)h=!0;if(!f.thumbnailLazyLoad||h)g=b.thumbImg().src;var k=ic(b),r=jc(b);"auto"==w()?d[m++]='<div class="imgContainer" style="width:'+l()+'px;"><img class="image" src="'+g+'" alt=" " style="max-width:'+l()+'px;"></div>':"auto"==l()?d[m++]='<div class="imgContainer" style="height:'+w()+'px;"><img class="image" src="'+
...
r+"</div></div>");d[m++]="</div></div>";a=jQuery(d.join("")).appendTo(e.conTnHid);b.$elt=a;a.data("index",c);a.find("img").data("index",c);kc(a,b);a.detach().appendTo(e.conTn);Hb(a);if(h)ngimagesLoaded(a).on("always",function(a){var b=p[jQuery(a.images[0].img).data("index")];if(void 0!=b&&"model:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw=="!=a.images[0].img.src){var c=!1;b.thumbImg().height!=a.images[0].img.naturalHeight&&(b.thumbSetImgHeight(a.images[0].img.naturalHeight),
...
la=b;if(""==c)e.vwImgC.css({opacity:0,left:0,visibility:"visible"}).attr("src","model:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==").attr("src",p[b].responsiveURL()),jQuery.when(e.vwImgC.animate({opacity:1},300)).done(function(){ra(b,c)});else switch(f.imageTransition){case "fade":var d="nextImage"==c?e.vwImgN:e.vwImgP;d.css({opacity:0,left:0,visibility:"visible"});jQuery.when(e.vwImgC.animate({opacity:0},500),d.animate({opacity:1},300)).done(function(){ra(b,
...
"model:image/gif;base64,R0lGODlhEAAQAIAAAP///////yH5BAEKAAEALAAAAAAQABAAAAIOjI+py+0Po5y02ouzPgUAOw==",a;a.src=this.thumbs.url[ba][ha];a.width=this.thumbs.width[ba][ha];a.height=this.thumbs.height[ba][ha];return a},responsiveURL:function(){var a="";switch(f.kind){case "":a=this.src;break;case "flickr":a=this.src;break;default:a=this.src}return a}};return b}();this.Initiate=function(b,c){f=c;e.base=jQuery(b);ja=e.base.attr("id");jQuery("body").css("overflow");Function.prototype.bind||(Function.prototype.bind=
